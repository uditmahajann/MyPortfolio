...
const CaseStudyDecisions: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="w-52 h-52 rounded-4xl border border-zinc-700 bg-zinc-900 flex flex-col items-center justify-center p-5 transition-all duration-300 hover:border-amber-300 hover:shadow-[0_0_40px_rgba(163,230,53,0.15)]">

        <div className="text-amber-300 mb-5">
          <Icon size={32} />
        </div>

        <h4 className="text-zinc-100 text-xl font-google font-medium leading-snug">
          {factor.title}
        </h4>
